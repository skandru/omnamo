    ...
    <footer className="bg-gray-100 text-gray-600 py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Organization Info */}
          <div>
            <h3 className="text-lg font-semibold mb-4">Community Organization</h3>
            <p className="mb-4">
              Supporting our community through cultural events and social gatherings.
            </p>
            <p>
              <a href="mailto:contact@community-org.example" className="text-blue-600 hover:underline">
                contact@community-org.example
              </a>
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/events">
                  <a className="hover:text-blue-600">Events</a>
                </Link>
              </li>
              <li>
                <Link href="/profile">
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 text-center">
          <p>&copy; {currentYear} Community Organization. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
